...
public class AppUtils {
    ...
    public static void uninstallApp(Context context, String packageName) {
        if (StringCovertUtils.isSpace(packageName)) return;
    ...
    public static String getAppVersionName() {
        return getAppVersionName(App.app, App.app.getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(App.app, App.app.getPackageName());
    }
    ...
    public static int getAppVersionCode(Context context, String packageName) {
        if (StringCovertUtils.isSpace(packageName)) return -1;
        try {
            PackageManager pm = context.getPackageManager();
            PackageInfo pi = pm.getPackageInfo(packageName, 0);
