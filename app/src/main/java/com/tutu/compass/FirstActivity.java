...
public class FirstActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    private void initPoint() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (i == 0) {
                iv_point.setBackgroundResource(R.drawable.circle_cheak);
            } else {
                iv_point.setBackgroundResource(R.drawable.circle_uncheak);
            }
    ...
    public void onPageSelected(int position) {
        ...
        for (int i = 0; i < length; i++) {
            ivPointArray[position].setBackgroundResource(R.drawable.circle_cheak);
            if (position != i) {
                ivPointArray[i].setBackgroundResource(R.drawable.circle_uncheak);
            }
        }
